...
const Footer = () => {
	...
	<div className="container flex flex-col p-4 mx-auto md:p-5 lg:flex-row dark:divide-gray-600">
		...
		<ul className="self-center py-6 space-y-4 text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start text-[#333]">
        <p className="flex items-center">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6 text-orange-400">
						<path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"></path>
					</svg>
					<span className="text-white">Bangladesh, Dhaka City</span>
				</p>
				<p className="flex items-center">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6 text-orange-400">
				...
				<p className="flex items-center">
					...
					<span className="text-white">artisanalcrafts@business.com</span>
				</p>
		</ul>
		<div className="flex flex-col justify-center pt-6 lg:pt-0">
			<div className="flex justify-center space-x-4">
				<div className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-orange-400 text-white  font-bold cursor-pointer">
	...
	<span className="text-white text-center mx-auto w-full flex justify-center pb-2">© Copyright 2024. All Rights Reserved.</span>
