...
const Footer = () => {
    return (
        <footer className=" border-t-2 border-orange-400 rounded-l rounded-r">
        ...
        <div className="divider before:bg-orange-400 after:bg-orange-400"><PiFlowerTulipDuotone className="text-5xl text-[#333] font-bold" /></div>
        </div>
