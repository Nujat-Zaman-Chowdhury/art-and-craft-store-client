    ...
    return (
       <ScrollTrigger onEnter={handleEnter} onExit={handleExit}>
         <div className="md:px-12 my-10">
            <h2 className="text-2xl md:text-4xl text-orange-500 font-lato font-bold text-center">Our Website Performance Metrics</h2>
	...
	<div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
		...
		<div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-50 dark:text-gray-800">
			...
			<div className="flex flex-col justify-center align-middle">
				<p className="text-3xl font-semibold leading-none">
                {
                        counterOn && <CountUp start={0} end={7500} duration={2} delay={0} />
                    }
                    +
                    </p>
		...
		<div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-50 dark:text-gray-800">
			...
			<div className="flex flex-col justify-center align-middle">
				...
				<p className="capitalize">Performance</p>
			</div>
		</div>
	</div>
</section>
