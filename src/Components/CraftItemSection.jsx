    ...
    return (
        <div className="my-10 md:my-20 container mx-auto px-2 lg:px-0">
            <div className="text-center mt-10 ">
                ...
                <p className="text-[#333] text-base md:text-xl font-workSans text-center mt-3">Browse through our collection below and click on "View Details" to uncover the secrets behind these exquisite treasures.</p>
            </div>
