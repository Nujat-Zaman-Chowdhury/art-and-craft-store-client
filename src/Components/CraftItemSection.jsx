    ...
    return (
        <div className="my-10 md:my-20 container mx-auto">
            <div className="text-center mt-10 ">
                ...
                <p className="text-[#333] md:text-xl text-center mt-3">Browse through our collection below and click on "View Details" to uncover the secrets behind these exquisite treasures.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols2 lg:grid-cols-3 gap-4 container mx-auto mt-10 md:px-12 font-lato">
			{
				CraftItems.slice(0,6).map(craftItem=>(
					<div key={craftItem._id} className="card w-full lg:w-96 bg-base-100 shadow-xl border border-orange-400">
